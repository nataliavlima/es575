...
SIGNAL \ff4|FFT4|tmp~1_combout\ : std_logic;
...
-- Equation(s):
-- \ff4|FFT3|tmp~0_combout\ = \ff4|FFT3|tmp~q\ $ (((\ff4|FFT2|tmp~q\ & (\SW[1]~input_o\ & \ff4|FFT1|tmp~q\))))
...
-- Equation(s):
-- \ff4|FFT4|tmp~0_combout\ = (!\ff4|FFT2|tmp~q\) # (!\SW[1]~input_o\)
...
PORT MAP (
	datab => \SW[1]~input_o\,
	datad => \ff4|FFT2|tmp~q\,
	combout => \ff4|FFT4|tmp~0_combout\);

-- Location: LCCOMB_X54_Y87_N8
\ff4|FFT4|tmp~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \ff4|FFT4|tmp~1_combout\ = \ff4|FFT4|tmp~q\ $ (((\ff4|FFT1|tmp~q\ & (\ff4|FFT3|tmp~q\ & !\ff4|FFT4|tmp~0_combout\))))
...
PORT MAP (
	...
	datad => \ff4|FFT4|tmp~0_combout\,
	combout => \ff4|FFT4|tmp~1_combout\);

-- Location: FF_X54_Y87_N9
\ff4|FFT4|tmp\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \disp1|disp_out[0]~0_combout\ = (\ff4|FFT2|tmp~q\ & (((\ff4|FFT4|tmp~q\)))) # (!\ff4|FFT2|tmp~q\ & (\ff4|FFT3|tmp~q\ $ (((\ff4|FFT1|tmp~q\ & !\ff4|FFT4|tmp~q\)))))
...
-- Equation(s):
-- \disp1|disp_out[1]~1_combout\ = (\ff4|FFT4|tmp~q\ & (((\ff4|FFT2|tmp~q\) # (\ff4|FFT3|tmp~q\)))) # (!\ff4|FFT4|tmp~q\ & (\ff4|FFT3|tmp~q\ & (\ff4|FFT1|tmp~q\ $ (\ff4|FFT2|tmp~q\))))
...
-- Equation(s):
-- \disp1|disp_out[2]~2_combout\ = (\ff4|FFT3|tmp~q\ & (((!\ff4|FFT4|tmp~q\)))) # (!\ff4|FFT3|tmp~q\ & (((\ff4|FFT1|tmp~q\ & !\ff4|FFT4|tmp~q\)) # (!\ff4|FFT2|tmp~q\)))
...
-- Equation(s):
-- \disp1|disp_out[3]~3_combout\ = (\ff4|FFT2|tmp~q\ & ((\ff4|FFT4|tmp~q\) # ((\ff4|FFT1|tmp~q\ & \ff4|FFT3|tmp~q\)))) # (!\ff4|FFT2|tmp~q\ & (\ff4|FFT3|tmp~q\ $ (((\ff4|FFT1|tmp~q\ & !\ff4|FFT4|tmp~q\)))))
...
-- Equation(s):
-- \disp1|disp_out[4]~4_combout\ = (\ff4|FFT1|tmp~q\) # ((\ff4|FFT2|tmp~q\ & (\ff4|FFT4|tmp~q\)) # (!\ff4|FFT2|tmp~q\ & ((\ff4|FFT3|tmp~q\))))
...
-- Equation(s):
-- \disp1|disp_out[5]~5_combout\ = (\ff4|FFT1|tmp~q\ & (!\ff4|FFT2|tmp~q\ & (\ff4|FFT4|tmp~q\ $ (\ff4|FFT3|tmp~q\)))) # (!\ff4|FFT1|tmp~q\ & ((\ff4|FFT3|tmp~q\ & ((!\ff4|FFT4|tmp~q\))) # (!\ff4|FFT3|tmp~q\ & (!\ff4|FFT2|tmp~q\))))
...
-- Equation(s):
-- \disp1|disp_out[6]~6_combout\ = (\ff4|FFT2|tmp~q\ & ((\ff4|FFT4|tmp~q\) # ((\ff4|FFT1|tmp~q\ & \ff4|FFT3|tmp~q\)))) # (!\ff4|FFT2|tmp~q\ & ((\ff4|FFT4|tmp~q\ $ (!\ff4|FFT3|tmp~q\))))
